...
with open('error_analysis/freq/aranea.lemma.pfv.txt', encoding='utf-8') as f:
    words = f.read().splitlines()

with open('error_analysis/freq/aranea.rank.nbr.pfv.txt', encoding='utf-8') as f:
...
#sns.scatterplot(data=tsne_results, x='tsne1', y='tsne2', hue='asp')
